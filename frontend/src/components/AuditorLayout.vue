  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <RouterLink to="/auditor/workbench" class="nav-item">
          <span class="nav-icon">🏠</span> 个人工作台
        </RouterLink>
        <div class="nav-section-title">审计操作</div>
        <RouterLink to="/auditor/projects" class="nav-item">
          <span class="nav-icon">📁</span> 选择项目
        </RouterLink>
        <div class="nav-section-title">结果与报告</div>
        <RouterLink to="/auditor/reports" class="nav-item">
          <span class="nav-icon">📄</span> 历史报告
        </RouterLink>
        <RouterLink to="/auditor/reports/generate" class="nav-item">
          <span class="nav-icon">✏️</span> 生成报告
        </RouterLink>
      </nav>
      <div class="sidebar-footer">
        <RouterLink to="/auditor/profile" class="nav-item">
...
.sidebar-footer { border-top: 1px solid var(--border-color); padding: 8px 0; }
.logout-btn { color: var(--danger-light); }
.main-content { flex: 1; overflow-y: auto; padding: 24px; background: var(--bg-dark); }
</style>
